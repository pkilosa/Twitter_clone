...
SECRET_KEY = 'django-insecure-j%kh2^=tr-+!2+r43k8#(6wcdh-3v(%fno4hl$ij$7c3+j2ciy'
...
cloudinary.config( 
  cloud_name = "dobpxsbrs", 
  api_key = "483769549829255", 
  api_secret = "qS1wIsBfuBWt5wTe7Fv1jwSUzgg",
  secure=True 
)
